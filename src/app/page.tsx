  ...
  return (
    <main style={styles.page}>
      <header style={styles.header}>
        <div style={styles.brand}>Cobrador <span style={{color:'#2563eb'}}>Pro</span></div>
        <nav><a href="/dashboard" style={styles.link}>Dashboard</a></nav>
      </header>
      ...
      <section style={styles.card}>
        ...
        <form action={captureLead} style={styles.form}>
          ...
          <div style={styles.field}>
            ...
            <textarea name="message" rows={4} placeholder="Ej: muchos clientes pagan tarde…" style={styles.textarea}/>
          </div>

          <button type="submit" style={styles.cta}>Quiero la demo</button>
      ...
      <footer style={styles.footer}>
        ...
        <div><a href="/dashboard" style={styles.link}>Ir al dashboard</a></div>
      </footer>
    </main>
  );
}

/** Estilos inline (rápidos, sin Tailwind) */
const styles: Record<string, any> = {
  page: { fontFamily:'system-ui, -apple-system, Segoe UI, Roboto, sans-serif', background:'#f8fafc', color:'#0f172a' },
  ...
  sub:{ fontSize:18, opacity:.9, margin:'8px 0 16px' },
  bullets:{ lineHeight:1.6, paddingLeft:16 },
  card:{ maxWidth:900, margin:'24px auto 48px', background:'#fff', border:'1px solid #e5e7eb', borderRadius:16, padding:24, boxShadow:'0 1px 2px rgba(0,0,0,.04)' },
  ...
  footer:{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'24px', fontSize:13, color:'#475569' }
};
